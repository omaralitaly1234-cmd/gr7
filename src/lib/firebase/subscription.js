...
// Plan definitions live in the framework-neutral lib/plans.js (single source of
// truth). Re-exported here so existing importers of '@/lib/firebase/subscription'
// keep working unchanged.
export { PLAN_DEFINITIONS, AI_FEATURES, AI_FEATURE_LABELS } from '@/lib/plans';
