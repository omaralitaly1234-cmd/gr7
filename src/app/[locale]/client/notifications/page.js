...
export default function ClientNotifications() {
  ...
  const notifications = [
    { icon: '🎉', title: locale === 'ar' ? 'مرحباً بك في GR 7!' : 'Welcome to GR 7!', body: locale === 'ar' ? 'نتمنى لك تجربة رائعة' : 'We wish you a great experience', time: '2026-03-23 10:00', read: false },
    ...
    { icon: '🎂', title: locale === 'ar' ? 'عيد ميلاد سعيد!' : 'Happy Birthday!', body: locale === 'ar' ? 'GR 7 تتمنى لك عيد ميلاد سعيد 🎉' : 'GR 7 wishes you a happy birthday 🎉', time: '2026-03-15 09:00', read: true },
  ];
